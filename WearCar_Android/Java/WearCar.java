...
import chansu.GearService.gearBtService;
import chansu.GearService.gearBtService.LocalBinder;


public class WearCar extends Activity implements OnClickListener{
	...
	public static final String LOG_TAG = "WearCar MainActivity";
    ...
    private ImageButton connectBlue;
    public static TextView modeName;
    public static TextView blueText;
    private ImageButton doorOpen;
    private ImageButton engineStart;
    private ImageButton batteryOn;
    private ImageButton lignt;
    private ImageButton warning;
    private ImageButton trunkOpen;
    public static ImageButton doorStatus;
    public static ImageButton doorStatus_on;
    public static ImageButton trunkStatus;
    public static ImageButton trunkStatus_on;
    public static ImageButton lamp;
    public static ImageButton lamp_on;
    
	public static int mRealMode = 0;
	public static int mDoorstatus = 0;
	public static int mLightstatus = 0;
	public static int mTrunkstatus = 0;
   
	public static View myView;
    
    private String SapEngineStop = "0";
    private String SapEngineStart = "1";
    private String SapPowerOff = "2";
    private String SapPowerOn = "3";
    private String SapCarLight_Off = "4";
    private String SapCarLight_On = "5";
    private String SapDoorLockOff = "6";
    private String SapDoorLockOn = "7";
    private String SapCarSpeaker_Off = "8";
    private String SapCarSpeaker_On = "9";
    private String SapTrunkOpen = "-";
    private String SapBtReset = "+";

//////////////////////////////////////////////////////////////////////////////////////////////////
//	gearService source
    private static final String TAG = "GearService in WearCar";
    private Context mCtxt;
    private gearBtService mGearService;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName arg0, IBinder service) {
            ...
            mGearService = ((LocalBinder) service).getService();
        }
    };
//////////////////////////////////////////////////////////////////////////////////////////////////    
...
//		gearService source		
		...
		mCtxt.bindService(new Intent(getApplicationContext(), gearBtService.class), 
...
//		mVibe.vibrate(200);
        ...
        connectBlue = (ImageButton)findViewById(R.id.connectBlue);        
        modeName = (TextView)findViewById(R.id.modeName);
        doorOpen = (ImageButton)findViewById(R.id.doorOpen);
        engineStart = (ImageButton)findViewById(R.id.engineStart);
        batteryOn = (ImageButton)findViewById(R.id.batteryOn);
        lignt = (ImageButton)findViewById(R.id.lignt);
        warning = (ImageButton)findViewById(R.id.warning);
        trunkOpen = (ImageButton)findViewById(R.id.trunkOpen);
        doorStatus = (ImageButton)findViewById(R.id.doorStatus);
        
//        doorStatus_on = (ImageButton)findViewById(R.id.doorStatus_on);
        trunkStatus = (ImageButton)findViewById(R.id.trunkStatus);
//        trunkStatus_on = (ImageButton)findViewById(R.id.trunkStatus_on);
        lamp = (ImageButton)findViewById(R.id.lamp);
//        lamp_on = (ImageButton)findViewById(R.id.lamp_on);
		
        modeName.setOnClickListener(this);
        connectBlue.setOnClickListener(this);
        modeName.setOnClickListener(this);
        doorOpen.setOnClickListener(this);
        engineStart.setOnClickListener(this);
        batteryOn.setOnClickListener(this);
        lignt.setOnClickListener(this);
        warning.setOnClickListener(this);
        trunkOpen.setOnClickListener(this);
        doorStatus.setOnClickListener(this);
//        doorStatus.setOnClickListener(this);
//        trunkStatus.setOnClickListener(this);
...
*/
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
		case R.id.connectBlue: 
			Log.i("Onclick","connect");
			...
			break;
		case R.id.modeName: 
			Log.i("Onclick","blueReset");
			if(mRealMode == 1){
				sendSap = SapBtReset.getBytes();
				send(sendSap);
			}
			break;
		case R.id.doorOpen: 
			Log.i("Onclick","doorOpen");
			if(mRealMode == 1){
				sendSap = SapBtReset.getBytes();
				send(sendSap);
			}
			break;
		case R.id.engineStart: 
			Log.i("Onclick","engineStart");
			if(mRealMode == 1){
				sendSap = SapEngineStart.getBytes();
				send(sendSap);
			}
			break;
		case R.id.batteryOn: 
			Log.i("Onclick","batteryOn");
			if(mRealMode == 1){
				sendSap = SapPowerOn.getBytes();
				send(sendSap);
			}
			break;
		case R.id.lignt: 
			Log.i("Onclick","lignt");
			sendSap = SapCarLight_On.getBytes();
			send(sendSap);
			break;
		case R.id.warning: 
			Log.i("Onclick","blueReset");
			if(mRealMode == 1){
				sendSap = SapCarSpeaker_On.getBytes();
				send(sendSap);
			}
			break;
		case R.id.trunkOpen: 
			Log.i("Onclick","trunkOpen");
			if(mRealMode == 1){
				sendSap = SapTrunkOpen.getBytes();
				send(sendSap);
			}
			break;
		case R.id.doorStatus: 
			Log.i("Onclick","doorStatus");
			//doorStatus.setVisibility(v.INVISIBLE);
			
			break;
		case R.id.trunkStatus: 
			Log.i("Onclick","trunkStatus");
			break;
		case R.id.lamp: 
			Log.i("Onclick","lamp");
			break;
            ...
            case MESSAGE_STATE_CHANGE:
                ...
                case BluetoothSerialService.STATE_CONNECTED:
                	if (mMenuItemConnect != null) {
                		...
                		mMenuItemConnect.setTitle(R.string.special_keys);
...
*/            
    ...
    private void doDocumentKeys() {
        new AlertDialog.Builder(this).setTitle("WearCar").setMessage(" Hi My name is Su\n"
        		+ " I'm senior in Korea\n"
        		+ " If you have any question\n"
        		+ " contact me using these address\n"
        		+ " https://www.facebook.com/chansu.suh\n"
                + " suhchansu@gmail.com\n"
                + " 2014.07.18\n").show();
     }

	public void SendToGear(byte[] buffer) throws IOException {
		gearBtService.writeSap(buffer);		
	}
}
...
class TerminalEmulator {
    ...
    public void append(byte[] buffer, int base, int length) {
        for (int i = 0; i < length; i++) {
            ...
            try {
                if (WearCar.LOG_CHARACTERS_FLAG) {
                    char printableB = (char) b;
                    if (b < 32 || b > 126) {
                        printableB = ' ';
                    }
                    Log.w(WearCar.LOG_TAG, "'" + Character.toString(printableB)
                            + "' (" + Integer.toString(b) + ")");
                }
                process(b);
                mProcessedCharCount++;
            } catch (Exception e) {
                Log.e(WearCar.LOG_TAG, "Exception while processing character "
    ...
    private void selectGraphicRendition() {
        for (int i = 0; i <= mArgIndex; i++) {
            ...
            if (code == 0) { // reset
                ...
                if (WearCar.LOG_UNKNOWN_ESCAPE_SEQUENCES) {
                    Log.w(WearCar.LOG_TAG, String.format("SGR unknown code %d", code));
                }
            }
        }
    }
...
*/
            ...
            private void mapAndSend(int c) throws IOException {
            	...
            	mWearCar.send(mBuffer);
            }
        };
    }
        
    public void write(byte[] buffer, int length) throws InterruptedException, IOException {
    	
    	
    	
/*    	
    	int i, match = 0;
    	char[] testarry = new char[length+1];
    	Log.i("write in WearCar0","test");
    	for(i=0; i<length ; i++) {
    		testarry[i] = (char) buffer[i];
    	}
    	testarry[length] = 0;
    	for(i=0; i<length ; i++) {
    		if(testarry[i] == '#') {
    	...
    	String confirmation = test.substring(i, i+10);

    	Log.i("write in WearCar1",""+testarry);
    	Log.i("write in WearCar2",""+match);
    	Log.i("write in WearCar2",""+confirmation);
    	byte[] arr = confirmation.getBytes();
    	if(WearCar.flag == true)
			mWearCar.SendToGear(arr);
*/
...
/*    	
        ...
        String test2 = new String(save,0,save.length);
        Log.i("test2",""+test2);
        
        
        if(WearCar.flag == true)
			mWearCar.SendToGear(buffer);
*/
...
/*
    	...
    	bytebuf.put(buffer);
    	int num =bytebuf.getInt();
    	
    	Integer.toBinaryString(num);

    	Log.i("goSapHear ",""+num);
    	byte mbyte = (byte)num;
    	Log.i("goSapHear2 ",""+mbyte);
    	Log.i("goSapHear3 ",""+(mbyte & 0xff));
...
/*
    	byte[] temp = buffer;
    	String temp2 = new String(buffer,0,buffer.length);
    	Log.i("ggoogogo"," "+temp2.charAt(2));
    	
    	if((temp2.charAt(2) & 0x02) == 2){
    		if(WearCar.flag == true)
    			mWearCar.SendToGear(buffer);
    	}
*/
    	/*
    	Log.i("Here is write",""+buffer);
    	String temp = new String(buffer,0,buffer.length);
    	Log.i("Here is write2",""+temp);
    	
    	byte b = buffer[0]; 
    	String binString = Integer.toBinaryString(b);
    	int binStringLength = binString.length(); 

    	if(binStringLength > 8) { // 음수라면 32비트이므로 하위 8비트를 놔두고 상위 비트들을 제거한다.   
    		binString = binString.substring(binStringLength - 8, binStringLength);} 
    	

    	Log.i("YAO", "value : " + b); 
    	Log.i("YAO2", "string : " + binString);
    	*/
//    	if((binString.charAt(2) & 0x02) == 2){

    	Log.i("YAO2", "WearCar.flag : " + WearCar.flag);
    	/*
    	if(WearCar.mRealMode == 1) {
    		...
    		//VISIBLE = 0
    		//INVISIBLE = 4
    		//WearCar.doorStatus.setVisibility(WearCar.myView.INVISIBLE);
    		WearCar.changeImage(0);
    		if((buffer[0] & 0x02)==0x02) {
    			WearCar.mDoorstatus = 0;
    			WearCar.doorStatus.setVisibility(WearCar.myView.VISIBLE);
    			WearCar.doorStatus_on.setVisibility(WearCar.myView.INVISIBLE);
    		} else {
    			WearCar.mDoorstatus = 1;
    			WearCar.doorStatus.setVisibility(WearCar.myView.INVISIBLE);
    			//WearCar.doorStatus_on.setVisibility(0);
    		
    		}
    		
    		if((buffer[0] & 0x40)==0x40) {
    			WearCar.mLightstatus = 1;
    			WearCar.lamp.setVisibility(WearCar.myView.INVISIBLE);
    			WearCar.lamp_on.setVisibility(WearCar.myView.VISIBLE);
    		} else {
    			WearCar.mLightstatus = 0;
    			WearCar.lamp.setVisibility(WearCar.myView.VISIBLE);
    			WearCar.lamp_on.setVisibility(WearCar.myView.INVISIBLE);
    		
    		}
    		
    		if((buffer[0] & 0x80)==0x80) {
    			WearCar.mTrunkstatus = 0;
    			WearCar.trunkStatus.setVisibility(WearCar.myView.VISIBLE);
    			WearCar.trunkStatus_on.setVisibility(WearCar.myView.INVISIBLE);
    		
    		} else {
    			WearCar.mTrunkstatus = 1;
    			WearCar.trunkStatus.setVisibility(WearCar.myView.INVISIBLE);
    			WearCar.trunkStatus_on.setVisibility(WearCar.myView.VISIBLE);
    		}
    	}
    	*/    	
...
///////////////////////////////////////////////////////////////////////////////////////////////////////    	
     ...
     */
    public void initialize(WearCar wearCar) {
    	mWearCar = wearCar;
        mTextSize = 15;
        mForeground = WearCar.WHITE;
        mBackground = WearCar.BLACK;
        updateText();
    ...
    void updateSize() {
        ...
        if (mKnownSize) {
            ...
            int h = visibleRect.height() - mWearCar.getTitleHeight() - 2;
